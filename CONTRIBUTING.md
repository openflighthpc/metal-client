# Contributing to Metal Client

:+1::tada: Thanks for taking the time to contribute! :tada::+1:

You want to contribute to Metal Client? Welcome! Please read this
...
You can help Metal Client by helping others who use it and need support.

## Analyse Issues

Analysing issue reports can be a lot of effort. Any help is welcome!
Go to [the GitHub issue tracker](https://github.com/openflighthpc/metal-client/issues?state=open)
...
If you find a bug - behaviour of Metal Client code or documentation
...
[GitHub issue tracker for Metal Client](https://github.com/openflighthpc/metal-client/issues/new)
to report the issue.
...
We want to improve the quality of Metal Client and good bug reports are
...
Metal Client is Open Source and comes without warranty.
...
Metal Client in order to fix bugs or to implement new features.
...
2. **Not all proposed contributions can be accepted**. Some features
   ...
   the overall direction of Metal Client and really improve it. The more
...
applied to Metal Client itself.

In particular you need to agree to the Contributor License Agreement,
which can be [found
here](https://www.clahub.com/agreements/openflighthpc/metal-client). This
...
8. Wait for our code review and approval, possibly enhancing your
   change on request.
    - Note that the Metal Client developers also have their regular
